...
const DEMO_JOBS = [
  ...
  },
  {
    ...
    company: 'Pixelforge Mobile',
    skills: ['Flutter', 'Kotlin', 'REST APIs', 'Firebase'],
    experienceLevel: 1,
    city: 'Chennai',
    description: 'Build and ship cross-platform mobile apps with Flutter and Kotlin. Integrate REST APIs, push notifications, and Firebase services.',
  },
  {
    title: 'Site Reliability Engineer',
    company: 'Cloudline',
    skills: ['Kubernetes', 'Prometheus', 'Grafana', 'Terraform', 'Linux'],
    experienceLevel: 3,
    city: 'Bangalore',
    description: 'Own reliability for containerized services: observability, SLOs, incident response, and infrastructure automation with Terraform.',
  },
  {
    ...
    experienceLevel: 2,
    city: 'Remote',
    description: 'Design, test, and audit smart contracts. Build secure on-chain integrations and developer tooling with Hardhat.',
  },
  {
    title: 'Game Developer',
    company: 'Northstar Interactive',
    skills: ['Unity', 'C#', 'Game Physics', 'Git'],
    experienceLevel: 2,
    city: 'Hyderabad',
    description: 'Prototype and ship gameplay systems in Unity with C#. Work on physics, performance, and tooling for a small studio team.',
  },
  {
    ...
    experienceLevel: 1,
    city: 'Chennai',
    description: 'Design product flows and interfaces, maintain the design system in Figma, and run usability tests with real users.',
  },
  {
    title: 'Network Engineer',
    company: 'Orbit Systems',
    skills: ['TCP/IP', 'Routing and Switching', 'Firewalls and VPNs', 'DNS'],
    experienceLevel: 2,
    city: 'Pune',
    description: 'Operate campus and cloud networks: routing, switching, firewalls, VPNs, DNS, and proactive network monitoring.',
  },
  {
    title: 'Database Administrator',
    company: 'VertexWorks',
    skills: ['PostgreSQL', 'Database Tuning', 'Indexing', 'Backup and Recovery'],
    experienceLevel: 3,
    city: 'Bangalore',
    description: 'Keep production databases fast and recoverable: tuning, indexing, replication, backups, and high-availability planning.',
  },
  {
    title: 'Business Analyst',
    company: 'Vortex Analytics',
    skills: ['Requirements Gathering', 'User Stories', 'SQL', 'Power BI'],
    experienceLevel: 1,
    city: 'Chennai',
    description: 'Translate stakeholder needs into clear requirements, user stories, and dashboards that guide product decisions.',
  },
];
